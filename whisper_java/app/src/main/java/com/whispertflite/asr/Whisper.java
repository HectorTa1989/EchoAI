...
import com.whispertflite.utils.TranscriptionPostProcessor;
...
//                            result = mWhisperEngine.getTranslation(mWavFilePath);
                    ...
                    // Apply post-processing for homonym correction and readability
                    if (result != null && !result.trim().isEmpty()) {
                        result = TranscriptionPostProcessor.processTranscription(result);
                        result = TranscriptionPostProcessor.improveReadability(result);
                    }
